...
# === Вставь сюда токен прямо, чтобы точно работало ===
BOT_TOKEN = "8361802125:AAEyQ91fL1D9lrgXqSLwINiRtk0IOLKdVrM"  # <-- вставь токен от BotFather
ADMIN_ID = 8291430081
...
async def paid(callback: CallbackQuery):
    ...
    await callback.message.answer(f"Пришлите скрин оплаты для заказа {order_id}")
    await callback.answer()
